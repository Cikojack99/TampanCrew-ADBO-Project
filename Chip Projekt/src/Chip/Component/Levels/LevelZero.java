...
@Override
    ...
    public void drawSecret(int x, int y) {
        if(x==4 && (y==19 || y==20))
        {
            ...
            this.petaLevel[0][19]=wall;
            this.petaLevel[0][20]=wall;

            this.petaLevel[4][19]=null;
            this.petaLevel[4][20]=null;

            this.petaLevel[2][19]=new Maps("item","mirrorArmor");
        } else if (x==22 && y==7)
        {
            this.petaLevel[x][y]=null;
        }
    ...
    public String getHint() {
        String hint = "<html>Ambilah kunci untuk membuka pintu <br> Jauhi Laser <br> Hati hati dengan penjaga<br>Hati hati dengan pintu yang tidak terlihat</html>";
        return hint;
    }
